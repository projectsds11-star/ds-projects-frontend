...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#003366] text-white border-t-8 border-[#F59E0B]">
            <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="h-1 w-10 bg-[#F59E0B] my-4"></div>
                        ...
                        <div className="mt-6 p-3 bg-black/10 border border-white/10 rounded-sm">
                            ...
                            <span className="font-mono text-[#F59E0B] font-bold text-xs tracking-wide">UDYAM-AP-13-0077732</span>
                        </div>
                    </div>

                    {/* Quick Links */}
                    <div>
                        <h4 className="font-bold text-lg mb-6 uppercase tracking-widest text-[#F59E0B]">{t('home')} & Info</h4>
                    ...
                    {/* Programs */}
                    <div>
                        <h4 className="font-bold text-lg mb-6 uppercase tracking-widest text-[#F59E0B]">Programs</h4>
                        <div className="flex flex-col gap-3">
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="font-bold text-lg mb-6 uppercase tracking-widest text-[#F59E0B]">Connect</h4>
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 group">
                                <div className="p-2 bg-white/10 group-hover:bg-[#F59E0B] transition-colors rounded-sm">
                                    <Phone size={16} />
                                </div>
                            ...
                            <a href="https://www.facebook.com/share/1HsRSGjEMu/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                                ...
                                <span className="text-sm font-bold text-gray-200 group-hover:text-[#F59E0B] transition-colors">Connect on Facebook</span>
                            </a>
                            <a href="https://youtube.com/@dsprojects?si=W6cKrLZ3qJoOa4xa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                                ...
                                <span className="text-sm font-bold text-gray-200 group-hover:text-[#F59E0B] transition-colors">Subscribe on YouTube</span>
                            </a>
                            <a href="https://www.instagram.com/projectds11?utm_source=qr&igsh=MXUyMmV0eXBtZnduaw==" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                                ...
                                <span className="text-sm font-bold text-gray-200 group-hover:text-[#F59E0B] transition-colors">Follow on Instagram</span>
                            </a>
                            <a href="https://x.com/SDS Projects81998" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                                <div className="p-2 bg-white/10 group-hover:bg-[#F59E0B] transition-colors rounded-sm">
                                    <Twitter size={16} />
                                </div>
                                <span className="text-sm font-bold text-gray-200 group-hover:text-[#F59E0B] transition-colors">Follow on X (Twitter)</span>
                            </a>
                            <a href="https://www.linkedin.com/in/shanmukha-project-s-6446423aa?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                                ...
                                <span className="text-sm font-bold text-gray-200 group-hover:text-[#F59E0B] transition-colors">Connect on LinkedIn</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 text-center">
                    ...
                    <div className="flex justify-center gap-6 mt-4 opacity-70">
                        <span className="text-[10px] uppercase font-black text-[#F59E0B]">Quality first</span>
